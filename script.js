// Configurações
const YOUTUBE_ID = "oAuKa5NOzWE"; // Substitua pelo ID do MV desejado (ex.: Ado - Usseewa)
...
if (mvModal) {
  mvModal.addEventListener("show.bs.modal", () => {
    ...
    if (frame) {
      const src = `https://www.youtube.com/embed/oAuKa5NOzWE?enablejsapi=1&autoplay=1`;
